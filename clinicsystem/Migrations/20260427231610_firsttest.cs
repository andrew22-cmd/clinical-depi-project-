    ...
    public partial class firsttest : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorScheduleSlots", x => x.SlotId);
                    table.ForeignKey(
                        name: "FK_DoctorScheduleSlots_DoctorSchedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_DoctorScheduleSlots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailNotifications_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientNotes", x => x.NoteId);
                    table.ForeignKey(
                        name: "FK_PatientNotes_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "ReservationId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorScheduleSlots_ScheduleId",
                table: "DoctorScheduleSlots",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailNotifications_ReservationId",
                table: "EmailNotifications",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientNotes_ReservationId",
                table: "PatientNotes",
                column: "ReservationId");
